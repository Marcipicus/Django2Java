...
@Entity
public class ScaleSignatureEntity {
	...
	protected ScaleSignatureEntity() {}
	
	public ScaleSignatureEntity(String name, String displayText, List<IntervalEntity> intervals) {
		super();
		this.id = null;
		this.name = name;
