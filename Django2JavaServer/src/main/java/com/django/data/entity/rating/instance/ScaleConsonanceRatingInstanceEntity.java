...
@Entity
public class ScaleConsonanceRatingInstanceEntity {
	...
	protected ScaleConsonanceRatingInstanceEntity() {}
	
	public ScaleConsonanceRatingInstanceEntity(ChordSignatureEntity referenceChordSignature,
			ScaleSignatureEntity scaleSignature, BigDecimal rating) {
		super();
		this.id = null;
